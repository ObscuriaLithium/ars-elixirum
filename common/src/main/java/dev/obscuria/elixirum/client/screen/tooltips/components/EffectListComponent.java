...
public record EffectListComponent(
        List<? extends Entry> entries
) implements ClientTooltipComponent {

    public EffectListComponent(ElixirContents entries) {
        this(builtEntries(entries));
    }
    ...
    private static List<Entry> builtEntries(ElixirContents contents) {
