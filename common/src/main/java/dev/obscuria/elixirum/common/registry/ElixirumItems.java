...
public interface ElixirumItems {
    ...
    DeferredItem<ElixirItem> ELIXIR = register("elixir", () -> new ElixirItem(new Item.Properties().stacksTo(8)));
    DeferredItem<HoneySolventItem> HONEY_SOLVENT = register("honey_solvent", () -> new HoneySolventItem(new Item.Properties()));
    DeferredItem<ExtractItem> EXTRACT = register("extract", () -> new ExtractItem(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE)));
