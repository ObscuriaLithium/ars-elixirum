...
public enum ElixirShape {
    ...
    public static final ElixirShape DEFAULT = ElixirShape.BOTTLE_1;
    private final int id;
    private final double requiredProgress;
    private final String texture;
    private final String overlay;

    ElixirShape(int id, double requiredProgress, String texture, String overlay) {
        this.id = id;
    ...
    public static ElixirShape getById(int id) {
