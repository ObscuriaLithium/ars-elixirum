...
import dev.obscuria.elixirum.server.alchemy.resources.providers.IApplicationMethodProvider;
import dev.obscuria.elixirum.server.alchemy.resources.providers.IEssenceProvider;
import dev.obscuria.elixirum.server.alchemy.resources.providers.ITemperProvider;
import dev.obscuria.elixirum.server.alchemy.resources.providers.IStabilityProvider;
...
public final class ElixirumRegistries {
    ...
    public static final DelegatedRegistry<Codec<? extends ITemperProvider>> TEMPER_PROVIDER_TYPE = REGISTRAR.createRegistry(Keys.TEMPER_PROVIDER_TYPE);
    public static final DelegatedRegistry<Codec<? extends IApplicationMethodProvider>> APPLICATION_METHOD_PROVIDER_TYPE = REGISTRAR.createRegistry(Keys.APPLICATION_METHOD_PROVIDER_TYPE);
    public static final DelegatedRegistry<Codec<? extends IStabilityProvider>> STABILITY_PROVIDER_TYPE = REGISTRAR.createRegistry(Keys.STABILITY_PROVIDER_TYPE);
    ...
    public interface Keys {
        ...
        ResourceKey<Registry<Codec<? extends ITemperProvider>>> TEMPER_PROVIDER_TYPE = create("temper_provider_type");
        ResourceKey<Registry<Codec<? extends IApplicationMethodProvider>>> APPLICATION_METHOD_PROVIDER_TYPE = create("application_method_provider_type");
        ResourceKey<Registry<Codec<? extends IStabilityProvider>>> STABILITY_PROVIDER_TYPE = create("stability_provider_type");
    ...
    public static void init() {
        ...
        ITemperProvider.bootstrap(BootstrapContext.create(REGISTRAR, Keys.TEMPER_PROVIDER_TYPE, ResourceLocation::new));
        IApplicationMethodProvider.bootstrap(BootstrapContext.create(REGISTRAR, Keys.APPLICATION_METHOD_PROVIDER_TYPE, ResourceLocation::new));
        IStabilityProvider.bootstrap(BootstrapContext.create(REGISTRAR, Keys.STABILITY_PROVIDER_TYPE, ResourceLocation::new));
