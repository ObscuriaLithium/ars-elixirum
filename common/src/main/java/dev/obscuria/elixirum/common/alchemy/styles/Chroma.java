...
public enum Chroma implements StringRepresentable {
    ...
    FOREST(1, 4, it -> ChromaColors.RGB_FOREST),
    MINT(2, 7, it -> ChromaColors.RGB_MINT),
    SEAFOAM(3, 10, it -> ChromaColors.RGB_SEAFOAM),
    SKY(4, 13, it -> ChromaColors.RGB_SKY),
    OCEAN(5, 16, it -> ChromaColors.RGB_OCEAN),
    VIOLET(6, 19, it -> ChromaColors.RGB_VIOLET),
    PURPLE(7, 22, it -> ChromaColors.RGB_PURPLE),
    MAGENTA(8, 25, it -> ChromaColors.RGB_MAGENTA),
    FUCHSIA(9, 28, it -> ChromaColors.RGB_FUCHSIA),
    TERRACOTTA(10, 31, it -> ChromaColors.RGB_TERRACOTTA),
    CARAMEL(11, 34, it -> ChromaColors.RGB_CARAMEL),
    OLIVE(12, 37, it -> ChromaColors.RGB_OLIVE),

    SHIMMERING_FOREST(101, 40, it -> ChromaColors.shimmering(ChromaColors.RGB_FOREST)),
    SHIMMERING_MINT(102, 43, it -> ChromaColors.shimmering(ChromaColors.RGB_MINT)),
    SHIMMERING_SEAFOAM(103, 46, it -> ChromaColors.shimmering(ChromaColors.RGB_SEAFOAM)),
    SHIMMERING_SKY(104, 49, it -> ChromaColors.shimmering(ChromaColors.RGB_SKY)),
    SHIMMERING_OCEAN(105, 52, it -> ChromaColors.shimmering(ChromaColors.RGB_OCEAN)),
    SHIMMERING_VIOLET(106, 55, it -> ChromaColors.shimmering(ChromaColors.RGB_VIOLET)),
    SHIMMERING_PURPLE(107, 58, it -> ChromaColors.shimmering(ChromaColors.RGB_PURPLE)),
    SHIMMERING_MAGENTA(108, 61, it -> ChromaColors.shimmering(ChromaColors.RGB_MAGENTA)),
    SHIMMERING_FUCHSIA(109, 64, it -> ChromaColors.shimmering(ChromaColors.RGB_FUCHSIA)),
    SHIMMERING_TERRACOTTA(110, 67, it -> ChromaColors.shimmering(ChromaColors.RGB_TERRACOTTA)),
    SHIMMERING_CARAMEL(111, 70, it -> ChromaColors.shimmering(ChromaColors.RGB_CARAMEL)),
    SHIMMERING_OLIVE(112, 73, it -> ChromaColors.shimmering(ChromaColors.RGB_OLIVE)),

    PULSING_FOREST(201, 76, it -> ChromaColors.pulsing(ChromaColors.RGB_FOREST)),
    PULSING_MINT(202, 79, it -> ChromaColors.pulsing(ChromaColors.RGB_MINT)),
    PULSING_SEAFOAM(203, 80, it -> ChromaColors.pulsing(ChromaColors.RGB_SEAFOAM)),
    PULSING_SKY(204, 82, it -> ChromaColors.pulsing(ChromaColors.RGB_SKY)),
    PULSING_OCEAN(205, 84, it -> ChromaColors.pulsing(ChromaColors.RGB_OCEAN)),
    PULSING_VIOLET(206, 86, it -> ChromaColors.pulsing(ChromaColors.RGB_VIOLET)),
    PULSING_PURPLE(207, 88, it -> ChromaColors.pulsing(ChromaColors.RGB_PURPLE)),
    PULSING_MAGENTA(208, 90, it -> ChromaColors.pulsing(ChromaColors.RGB_MAGENTA)),
    PULSING_FUCHSIA(209, 92, it -> ChromaColors.pulsing(ChromaColors.RGB_FUCHSIA)),
    PULSING_TERRACOTTA(210, 94, it -> ChromaColors.pulsing(ChromaColors.RGB_TERRACOTTA)),
    PULSING_CARAMEL(211, 96, it -> ChromaColors.pulsing(ChromaColors.RGB_CARAMEL)),
    PULSING_OLIVE(212, 98, it -> ChromaColors.pulsing(ChromaColors.RGB_OLIVE)),
