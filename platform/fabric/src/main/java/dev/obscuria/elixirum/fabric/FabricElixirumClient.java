...
public final class FabricElixirumClient implements ClientModInitializer {
    ...
    private static void registerItemColors() {
        ColorProviderRegistry.ITEM.register(ElixirContents::getOverlayColor, ElixirumItems.ELIXIR.asItem());
        ColorProviderRegistry.ITEM.register(ElixirContents::getOverlayColor, ElixirumItems.SPLASH_ELIXIR.asItem());
        ColorProviderRegistry.ITEM.register(ElixirContents::getOverlayColor, ElixirumItems.WITCH_TOTEM_OF_UNDYING.asItem());
        ColorProviderRegistry.ITEM.register(ExtractContents::getOverlayColor, ElixirumItems.EXTRACT.asItem());
    }
